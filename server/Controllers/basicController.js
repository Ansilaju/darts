...
// Register a student for Basic Plan (Cyber Security)
export const registerbasic = async (req, res) => {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <h3>New Student enrolled in Basic Plan (Cyber Security)</h3>
...
// Get all students in Basic Plan
