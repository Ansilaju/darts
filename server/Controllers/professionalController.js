...
// Register a student for Professional Photoshop (VFX)
export const registerProfessional = async (req, res) => {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <h3>New Student enrolled in Professional Photoshop (VFX)</h3>
...
// Get all students enrolled in Professional Photoshop
export const getAllProfessional = async (req, res) => {
  try {
