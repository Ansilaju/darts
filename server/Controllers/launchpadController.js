...
// Register a student for Launchpad999 (Digital Marketing)
export const registerLaunchpad = async (req, res) => {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <h3>New Student enrolled in Launchpad999 (Digital Marketing)</h3>
...
// Get all students enrolled in Launchpad999
