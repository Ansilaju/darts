...
// Register a student for Frontend Developer (MERN STACK)
export const registerFrontend = async (req, res) => {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <h3>New Student enrolled in Frontend Developer (MERN STACK)</h3>
...
// Get all students enrolled in Frontend Developer
export const getAllFrontend = async (req, res) => {
  try {
...
export const deleteFrontend = async (req, res) => {
  try {
